...
def summa(message):
    ...
    if amount > 0:
        ...
        bot.send_message(message.chat.id, 'Число должно быть больше 0. Впишите сумму больше 0.')
        bot.register_next_step_handler(message, summa)
...
def my_currency(message):
    try:
        ...
        bot.send_message(message.chat.id, f'Что-то не так. Впишите значение заново. (пример: USD/EUR). Ошибка: {str(e)}')
